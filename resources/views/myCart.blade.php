...
<form action="{{route('payment.post')}}" method="post" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="pk_test_51JMZxHLv3qp2oXfmiFOVEltPtNRHohE7DHQgIHdzxwLIRhGrq3uxfAAhRyxiXC4FGlFN9E9kGdg7UsCp6kV49oR500vQn40EjC" id="payment-form">  
   @csrf
<div class="row">
